...
3. In the command prompt, run the bash script `$ ./optical_disks.sh` (script is available on the [RAC GitHub](https://github.com/RockefellerArchiveCenter/imaging_scripts/blob/master/optical_disks.sh))
